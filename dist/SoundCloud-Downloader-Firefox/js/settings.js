...
function saveSettings(e) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const configKey of config_1.configKeys) {
            ...
            savePromises.push((0, config_1.storeConfigValue)(configKey, value));
        }
...
function restoreSettings() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield (0, config_1.loadConfiguration)();
            logger.logInfo("Configuration loaded.");
            for (const configKey of config_1.configKeys) {
                const elem = document.querySelector(`#${configKey}`);
                if (elem === null)
                    continue;
                const value = (0, config_1.getConfigValue)(configKey);
...
function clearDownloadHistory() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield (0, config_1.storeConfigValue)("track-download-history", {});
...
/******/ 	var __webpack_exports__ = __webpack_require__(1451);
/******/ 	
/******/ })()
;