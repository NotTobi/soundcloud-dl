...
var call = __webpack_require__(1549);
...
var _scripts = _interopRequireDefault(__webpack_require__(5142));
/*!
...
var _sliceInstanceProperty = __webpack_require__(5186);
var _Array$from = __webpack_require__(2014);
var arrayLikeToArray = __webpack_require__(1607);
...
var _Array$isArray = __webpack_require__(2382);
...
const domObserver_1 = __webpack_require__(9684);
const logger_1 = __webpack_require__(5628);
const compatibilityStubs_1 = __webpack_require__(9323);
...
(0, compatibilityStubs_1.onMessage)(handleMessageFromBackgroundScript);
...
const createDownloadCommand = (url) => (downloadId) => {
    ...
    return (0, compatibilityStubs_1.sendMessageToBackend)({
...
const handleBlockRepostsConfigChange = (blockReposts) => {
    ...
    if (blockReposts) {
        ...
        const payloadFile = (0, compatibilityStubs_1.getPathFromExtensionFile)("/js/repostBlocker.js");
        if (!payloadFile)
            return;
...
(0, config_1.loadConfiguration)(true).then((config) => {
    for (const key of config_1.configKeys) {
        if (config[key].secret)
            continue;
        writeConfigValueToLocalStorage(key, config[key].value);
    }
    (0, config_1.setOnConfigValueChanged)(writeConfigValueToLocalStorage);
    if (config["block-reposts"].value)
        handleBlockRepostsConfigChange(true);
    (0, config_1.registerConfigChangeHandler)("block-reposts", handleBlockRepostsConfigChange);
});
...
module.exports = __webpack_require__(9029);
...
const logger_1 = __webpack_require__(5628);
const compatibilityStubs_1 = __webpack_require__(9323);
const download_1 = __webpack_require__(7984);
...
const config = {
    ...
    "user-id": { secret: true },
    "default-download-location": { defaultValue: "SoundCloud", sanitize: (value) => (0, download_1.sanitizeFilenameForDownload)(value) },
...
function storeConfigValue(key, value) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (sync) {
                yield (0, compatibilityStubs_1.setSyncStorage)({ [key]: value });
            }
            else {
                yield (0, compatibilityStubs_1.setLocalStorage)({ [key]: value });
            }
            if (entry.onChanged)
...
function loadConfigValue(key) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let result;
        if (sync)
            result = yield (0, compatibilityStubs_1.getSyncStorage)(key);
        else
            result = yield (0, compatibilityStubs_1.getLocalStorage)(key);
...
function loadConfigValues(keys) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign(Object.assign({}, (yield (0, compatibilityStubs_1.getSyncStorage)(syncKeys))), (yield (0, compatibilityStubs_1.getLocalStorage)(localKeys)));
    });
}
function loadConfiguration(monitorStorage = false) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (monitorStorage && !isStorageMonitored) {
            (0, compatibilityStubs_1.onStorageChanged)(handleStorageChanged);
...
exports["default"] = void 0;
var _xregexp = _interopRequireDefault(__webpack_require__(6011));
var _build = _interopRequireDefault(__webpack_require__(6692));
var _matchrecursive = _interopRequireDefault(__webpack_require__(7409));
var _unicodeBase = _interopRequireDefault(__webpack_require__(7801));
var _unicodeCategories = _interopRequireDefault(__webpack_require__(7884));
var _unicodeProperties = _interopRequireDefault(__webpack_require__(9749));
var _unicodeScripts = _interopRequireDefault(__webpack_require__(302));
...
module.exports = __webpack_require__(8251);
...
var _getIteratorMethod = __webpack_require__(1519);
var _pushInstanceProperty = __webpack_require__(1958);
...
var arrayWithHoles = __webpack_require__(1251);
var iterableToArrayLimit = __webpack_require__(4172);
var unsupportedIterableToArray = __webpack_require__(426);
var nonIterableRest = __webpack_require__(2963);
...
module.exports = __webpack_require__(4908);
...
var _sliceInstanceProperty2 = __webpack_require__(8979);
var _Array$from = __webpack_require__(9763);
var _Symbol = __webpack_require__(6781);
var _getIteratorMethod = __webpack_require__(2222);
var _Array$isArray = __webpack_require__(6615);
var _Object$defineProperty = __webpack_require__(3930);
var _interopRequireDefault = __webpack_require__(5946);
_Object$defineProperty(exports, "__esModule", {
  value: true
...
exports["default"] = void 0;
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(4875));
var _create = _interopRequireDefault(__webpack_require__(7681));
var _flags = _interopRequireDefault(__webpack_require__(2730));
var _sort = _interopRequireDefault(__webpack_require__(129));
var _slice = _interopRequireDefault(__webpack_require__(8979));
var _parseInt2 = _interopRequireDefault(__webpack_require__(6586));
...
module.exports = __webpack_require__(4525);
...
module.exports = __webpack_require__(8402);
...
module.exports = __webpack_require__(4139);
...
module.exports = __webpack_require__(3658);
...
var _sliceInstanceProperty = __webpack_require__(8979);
var _Array$from = __webpack_require__(9763);
var _Symbol = __webpack_require__(6781);
var _getIteratorMethod = __webpack_require__(2222);
var _Array$isArray = __webpack_require__(6615);
...
exports["default"] = void 0;
var _categories = _interopRequireDefault(__webpack_require__(4311));
/*!
...
const xregexp_1 = __importDefault(__webpack_require__(3050));
...
function sanitizeFilenameForDownload(input) {
    ...
    sanitized = xregexp_1.default.replace(sanitized, (0, xregexp_1.default)("[^\\p{L}\\p{N}\\p{Zs}]]", "g"), "");
...
exports["default"] = void 0;
var _properties = _interopRequireDefault(__webpack_require__(8477));
/*!
...
/******/ 	var __webpack_exports__ = __webpack_require__(1481);
/******/ 	
/******/ })()
;